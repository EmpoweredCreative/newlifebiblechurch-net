...
return [
    ...
    */
    ...
    'min_fill_ms' => (int) env('REGISTRATION_MIN_FILL_MS', 2_000),
    ...
    /** Allowed clock skew: client time can be this many ms ahead of the server before we reject as "future". */
    'clock_skew_ms' => (int) env('REGISTRATION_CLOCK_SKEW_MS', 600_000),
